...
{
    /// <summary>
    /// Base class for tasks generated by the <see cref="Tkl.Jumbo.Jet.Jobs.Builder.JobBuilder.Generate{T}(int, Action{Tkl.Jumbo.IO.RecordWriter{T},ProgressContext})"/> method.
    /// </summary>
