...
namespace Tkl.Jumbo.Jet
{
    ...
    ///   consider reads/writes that are not already reported via the regular <see cref="Tkl.Jumbo.IO.RecordReader{T}.InputBytes"/>
    ///   and <see cref="Tkl.Jumbo.IO.RecordWriter{T}.OutputBytes"/> properties.
    /// </para>
    /// <para>
