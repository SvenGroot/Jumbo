...
namespace NameServerTests
{
    ...
    public class DirectoryTest
    {
        ...
        {
            Directory target = new Directory("testname", DateTime.Now);
            Assert.AreEqual(target.Children.Count, 0);
            File newItem = new File("testfile", DateTime.Now);
        ...
        public void DirectoryConstructorTest()
        {
            ...
            Directory target = new Directory(name, dateCreated);
        ...
        public void DirectoryConstructorEmptyNameTest()
        {
