...
namespace Tkl.Jumbo.Jet.Samples
{
    ...
    public sealed class WordCount : AccumulatorJob
    {
        ...
        public WordCount([Description("The input file or directory on the Jumbo DFS containing the text to perform the word count on.")] string inputPath, 
            ...
            : base(inputPath, outputPath, combinerTasks, typeof(WordCountTask), null, typeof(WordCountAccumulatorTask), null, typeof(WordRecordReader), typeof(TextRecordWriter<KeyValuePairWritable<Utf8StringWritable, int>>), null)
        {
            if( inputPath == null )
