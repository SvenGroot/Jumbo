...
namespace Tkl.Jumbo.Jet.Samples
{
    ...
    public class DbGen : BaseJobRunner
    {
        ...
        public override Guid RunJob()
        {
            ...
            StageConfiguration lineItemStage = jobConfig.AddStage("LineItem", null, typeof(TpcHTableGenTask), _taskCount, Tkl.Jumbo.Jet.Channels.ChannelType.File, Tkl.Jumbo.Jet.Channels.ChannelConnectivity.Full, null, _outputPath, typeof(RecordFileWriter<LineItem>));
