...
namespace Tkl.Jumbo.Jet.Samples
{
    ...
    public class GenerateText : JobBuilderJob
    {
        ...
        /// The size per task.
        /// </value>
        [CommandLineArgument(Position = 2), Description("The size of the data to generate per task. Specify zero to use the DFS block size."), Tkl.Jumbo.Jet.Jobs.JobSetting]
        ...
        /// The words per line.
        /// </value>
        [CommandLineArgument(DefaultValue = 10), Description("The number of words per line"), Tkl.Jumbo.Jet.Jobs.JobSetting]
        ...
        /// </value>
        [CommandLineArgument(DefaultValue = 5), Description("The amount by which the number of words per line will be varied."), Tkl.Jumbo.Jet.Jobs.JobSetting]
