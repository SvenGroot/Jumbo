...
namespace Tkl.Jumbo.Jet.Samples.Tasks
{
    ...
    /// </summary>
    [AllowRecordReuse]
    public class WordCountCombinerTask : IPullTask<KeyValuePairWritable<StringWritable, Int32Writable>, KeyValuePairWritable<StringWritable, Int32Writable>>
    {
        #region Nested types
        ...
        private static readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(WordCountCombinerTask));
